...
def update_user_preferences(user_id):
    try:
        ...
        cursor.execute("SELECT id FROM CosineWeights WHERE userID = %s", (user_id,))
        existing = cursor.fetchone()

        if existing:
            update_query = """
                UPDATE CosineWeights
            ...
            insert_query = """
                INSERT INTO CosineWeights (userID, preventionWeight, detectReportWeight, rapidRespWeight, healthSysWeight, intlNormsWeight, riskEnvWeight)
